...
class MistralRMSNorm(nn.Module):
    ...
    def forward(self, hidden_states):
        ...
        # print(f"weight device: {self.weight.device}, hidden_states: {hidden_states.device}")
...
class MistralRotaryEmbedding(nn.Module):
    def __init__(self, dim, max_position_embeddings=2048, base=10000, device=None):
        ...
        self.base = base
        inv_freq = 1.0 / (self.base ** (torch.arange(0, self.dim, 2).float() / self.dim)) #1.0 / (self.base ** (torch.arange(0, self.dim, 2).float().to(device) / self.dim))
...
class MistralSdpaAttention(MistralAttention):
    ...
    def forward(
        ...
        # print(f"hidden: {hidden_states.device}, q_proj: {self.q_proj.weight.device}")
...
#
#     def pooler(**kwargs):
#         print("abstract pooler doing nothing")
#
